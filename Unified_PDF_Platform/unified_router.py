...
WORK_COMPENSATION_BACKEND_DIR = BASE_DIR.parent / "Work_Compensation_pdf_extractor-main/backend"
...
sys.path.insert(0, str(WORK_COMPENSATION_BACKEND_DIR))
...
class UnifiedRouter:
    ...
    def _pre_classify(self, filename, file_ext, text_snippet=""):
        ...
        insurance_fn_kw = ["medlink", "medsupp", "cobra", "group benefit", "beneficiary"]
        ...
        # RULE C3: Vendor / SaaS / utility invoice (GST, subscription, utility, common invoice headers)
        ...
        # RULE C4: Insurance premium billing invoice (carrier billing members)
